/**
 * ============================================================================
 * MOTOR CONTÁBIL - ENGINE DE LANÇAMENTOS
 * ============================================================================
 * 
 * O QUE ESTE ARQUIVO FAZ?
 * ------------------------
 * Este é o "coração" da contabilidade. Ele gerencia:
 ...
 * LIVRO DIÁRIO:
 * -------------
 * Registro cronológico de TODAS as operações financeiras.
 * Cada lançamento tem:
 * - Número sequencial
 * - Data
 * - Histórico
 ...
 * ANALOGIA:
 * ---------
 * Pense como um "sistema de tripla entrada":
...
export class AccountingEngine {
   ...
   * 
   * O QUE FAZ?
   * Cria número sequencial para o Diário
   * 
   * PARÂMETROS:
  ...
  /**
   * CRIAR LANÇAMENTO NO DIÁRIO
   * --------------------------
   * 
   * O QUE FAZ?
   * Registra operação financeira no Livro Diário
   * 
   * PARÂMETROS:
  ...
  createJournalEntry(
    ...
    // 5. Monta histórico
    const history = `${transaction.description} - ${transaction.operationNature || 'Operação financeira'}`;
    ...
    if (isIncome) {
      // Receita: Débito em Caixa, Crédito em Receita
      debitValue = transaction.amount;
      creditValue = transaction.amount;
    } else {
      // Despesa: Débito em Despesa, Crédito em Caixa
      debitValue = transaction.amount;
      creditValue = transaction.amount;
    }
   ...
   * 
   * O QUE FAZ?
   * Extrai todos os lançamentos de uma conta específica
   * 
   * PARÂMETROS:
