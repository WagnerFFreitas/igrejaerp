/**
 * ============================================================================
 * LGPDCONSENTMODAL.TSX
 * ============================================================================
 *
 * O QUE ESTE ARQUIVO FAZ?
 * ------------------------
 * Componente visual do frontend para l g p d consent modal.
 *
 * ONDE É USADO?
 * -------------
...
import { LGPDConsent, LGPDPolicy } from '../tipos';
 ...
 * ===============
 *
 * Define o bloco principal deste arquivo (l g p d consent modal).
 */
  ...
  const handleSubmit = async () => {
    ...
    try {
      const consentData: LGPDConsent = {
        ...
        concedido: consents.dataProcessing,
      ...
      const communicationConsent: LGPDConsent = {
        ...
        concedido: consents.communication
      };
