 ...
 * ------------------------
 * Serviço do frontend para data initializer.
 *
 * ONDE É USADO?
 * -------------
 ...
 * ===============
 *
 * Define o bloco principal deste arquivo (data initializer).
 */
...
export const InicializadorDados = {
    ...
    try {
      ...
      if (funcionarios.length === 0) {
        ...
        const essentialFields = [
          ...
          'contato_emergencia', 'tipo_sanguineo', 'is_pcd', 'observacoes_saude',
        ...
        for (const emp of funcionarios) {
          ...
          if (!updatedEmp.matricula) {
            ...
            const index = funcionarios.indexOf(emp) + 1;
  ...
  getRealisticValue(field: string): any {
    const realisticData: Record<string, any> = {
      ...
      contato_emergencia: 'Maria Alves - (31) 98888-7777',
