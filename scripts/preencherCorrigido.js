// Script corrigido para preencher formulário automaticamente
// Execute no console após fazer login

console.log('🎯 CRIANDO FUNCIONÁRIOS VIA INTERFACE (VERSÃO CORRIGIDA)...');
...
console.log('✅ Script corrigido carregado!');
console.log('📋 Para preencher:');
console.log('   - Maria: preencherMaria()');
console.log('   - José: preencherJose()');
