// Script para adicionar os 3 funcionários que faltam
// Execute no console após fazer login

console.log('🎯 ADICIONANDO OS 3 FUNCIONÁRIOS RESTANTES...');
        ...
        setTimeout(() => {
          ...
          if (btnNovo) {
            ...
            setTimeout(() => {
              ...
              console.log('📋 Clique em "Salvar" para finalizar!');
            }, 2000);
          }
        }, 2000);
      }
...
// Criar funções para os 3 funcionários restantes
...
console.log('✅ Script para os 3 funcionários restantes carregado!');
console.log('📋 Status atual:');
console.log('   ✅ Jefferson (já cadastrado)');
console.log('   ✅ Wagner (já cadastrado)');
console.log('📋 Para adicionar os outros 3:');
console.log('   - Ana: preencherAna()');
console.log('   - Carlos: preencherCarlos()');
console.log('   - Maria: preencherMaria()');
