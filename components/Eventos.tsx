 ...
 * ------------------------
 * Componente visual do frontend para eventos.
 *
 * ONDE É USADO?
 * -------------
 ...
 * ===============
 *
 * Define o bloco principal deste arquivo (eventos).
 */
...
export const Eventos: React.FC<EventosProps> = ({ currentUnitId, members, user }) => {
  ...
  const handleSaveEvent = () => {
    if (!canWriteEvents) {
      alert('Você não tem permissão para criar ou editar eventos.');
      return;
    }
  ...
  const handleAddToSchedule = () => {
    if (!canWriteEvents) {
      alert('Você não tem permissão para alterar a escala do evento.');
      return;
    }
  ...
  const handleRemoveFromSchedule = (scheduleId: string) => {
    if (!canDeleteEvents && !canWriteEvents) {
      alert('Você não tem permissão para remover itens da escala.');
      return;
    }
    ...
    <div className="space-y-6 animate-in fade-in">
      <div className="flex justify-between items-end">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-indigo-600 text-white px-5 py-2.5 rounded-xl font-bold shadow-lg shadow-indigo-100 hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
              ...
              <div className="p-6">
                ...
                <div className="mt-4 flex gap-2">
                  <button
                    ...
                    disabled={!canWriteEvents}
                    className="flex-1 flex items-center justify-center gap-1.5 bg-indigo-600 text-white px-3 py-2 rounded-lg text-xs font-bold hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
          ...
          <div className="col-span-full">
            <div className="bg-white rounded-2xl border border-slate-100 p-12 text-center">
              ...
              <button
                onClick={() => setIsModalOpen(true)}
                disabled={!canWriteEvents}
                className="mx-auto flex items-center gap-2 bg-indigo-600 text-white px-6 py-3 rounded-xl font-bold hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-8">
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                ...
                disabled={!canWriteEvents}
                className="flex-1 bg-indigo-600 text-white px-4 py-2.5 rounded-xl font-bold hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Salvar
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              <div className="bg-slate-50 rounded-2xl p-6 mb-6">
                ...
                <button
                  ...
                  disabled={!canWriteEvents}
                  className="mt-4 bg-indigo-600 text-white px-6 py-2.5 rounded-xl font-bold hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                      ...
                      <div key={schedule.id} className="bg-white border border-slate-200 rounded-xl p-4">
                        <div className="flex justify-between items-start">
                          ...
                          <button
                            ...
                            disabled={!canDeleteEvents && !canWriteEvents}
