/**
 * ============================================================================
 * AVALIACAODASHBOARDWIDGET.TSX
 * ============================================================================
 *
 * O QUE ESTE ARQUIVO FAZ?
 * ------------------------
 * Componente visual do frontend para avaliacao dashboard widget.
 *
 * ONDE É USADO?
 * -------------
 ...
 * ===============
 *
 * Define o bloco principal deste arquivo (avaliacao dashboard widget).
 */
    ...
    const loadRankings = async () => {
      ...
      const realRankings: EmployeeRanking[] = employees.map((employee, index) => {
        ...
        return {
          ...
          cargo: employee.cargo || 'Sem cargo',
          departamento: employee.departamento || 'Sem departamento',
          score,
