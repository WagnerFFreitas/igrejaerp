 ...
 * ------------------------
 * Componente visual do frontend para auditoria.
 *
 * ONDE É USADO?
 * -------------
 ...
 * ===============
 *
 * Define o bloco principal deste arquivo (auditoria).
 */
  ...
  useEffect(() => {
    try {
      ...
      if (userString) {
        ...
        setCurrentUser(user);
        setCanViewAudit(user.role === 'DEVELOPER' || user.role === 'ADMIN');
      }
    } catch (error) {
  ...
  const loadLogs = async () => {
    ...
    try {
      ...
      const stats = {
        ...
        failures: logs.filter(log => log.success === false).length,
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-red-700 mb-3">
                  Esta área é restrita a perfis com auditoria avançada. Apenas administradores e o desenvolvedor podem acessar os logs de auditoria.
                </p>
                <div className="bg-red-100 border border-red-200 rounded-xl p-3">
                  ...
                  <p className="text-sm text-red-600 mt-1">
                    <strong>Permissão necessária:</strong> ADMIN ou DEVELOPER
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-black text-slate-900">{auditStats.today}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-black text-slate-900">{auditStats.failures}</p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="space-y-2 text-xs">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-black">{auditStats.creates}</span>
                  </div>
                  <div className="flex justify-between">
