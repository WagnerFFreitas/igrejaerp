...
export const FolhaPagamento: React.FC<FolhaPagamentoProps> = ({
  ...
  const handleCalculatePayroll = async () => {
    ...
    try {
      ...
      try {
        await payrollService.saveCalculation(calculation);
      } catch (saveError) {
        console.error('Erro ao persistir cálculo no banco:', saveError);
        // Não bloqueia a visualização se o salvamento falhar, mas avisa no console
      }
