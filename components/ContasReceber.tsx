...
Descrição: ${receivable.descricao}
            ...
            <tbody className="divide-y divide-slate-50 text-[11px]">
              {filteredReceivables.map(receivable => (
                <tr key={receivable.id} className="hover:bg-slate-50/50 transition-all">
                  ...
                  <td className="px-4 py-3">
                    <p className="font-bold text-slate-900 leading-none">{receivable.descricao}</p>
              ...
              {alerts.map(alert => (
                <div key={alert.transactionId} className={`p-4 rounded-xl border-l-4 ${
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="font-bold text-slate-900 text-xs">{alert.descricao}</p>
