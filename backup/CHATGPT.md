...
igrejaerp.zip
Arquivo zip
faça o cruzamento dos arquivos do projeto com E:\igrejaerp\conversão.md, E:\igrejaerp\nomenclaturas_tabelas.md​ e E:\igrejaerp\backup\igrejairp.sql

Pensamento interrompido
Concluí o cruzamento inicial entre os arquivos do projeto, o banco igrejairp.sql e o arquivo nomenclaturas_tabelas.md.
...
Recomendações adicionais após cruzamento
Criar imediatamente
dicionário oficial de entidades

dicionário oficial de colunas

padronização única PT-BR

migrations oficiais

mapa de FKs

mapa de dependências React

mapa de rotas Express
...
Eliminar tabelas duplicadas

Revisar rotas repetidas

Criar dicionário oficial de entidades

Consolidar models/interfaces
...
employee_id	employee_dependents, employee_leaves, payroll, `per
