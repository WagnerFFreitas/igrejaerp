...
const tableDefinitions: Record<string, string[]> = {
  ...
  funcionarios: [
    ...
    'data_nascimento', 'sexo', 'estado_civil', 'tipo_sanguineo', 'email', 'telefone', 'celular',
    'contato_emergencia', 'naturalidade', 'escolaridade', 'raca_cor',
  ...
  periodos_folha: ['id', 'id_unidade', 'month', 'year', 'start_date', 'end_date', 'criado_por', 'notes', 'status'],
  calculos_folha: [
    'id', 'id_funcionario', 'competency_month', 'gross_salary',
    ...
    'farmacia', 'seguro_vida', 'advance', 'consignado', 'coparticipation', 'absences', 'delays', 'alimony', 'other_deductions',
  ...
  contagens_inventario: ['id', 'id_unidade', 'count_date', 'counted_by', 'status', 'total_assets', 'total_expected', 'started_at', 'completed_at', 'total_found', 'completion_percentage'],
  itens_inventario: ['id', 'inventory_count_id', 'id_patrimonio', 'asset_name', 'category', 'expected_quantity', 'counted_quantity', 'difference', 'condition', 'observations'],
  eventos_igreja: ['id', 'id_unidade', 'titulo', 'descricao', 'data_evento', 'hora_evento', 'local_evento', 'quantidade_presentes', 'type', 'eh_recorrente', 'padrao_recorrencia', 'data_final_recorrencia', 'evento_id_transacao_origem', 'eh_evento_gerado', 'criado', 'atualizado'],
