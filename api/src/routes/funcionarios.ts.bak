...
function buildPessoaData(body: Record<string, any>): Record<string, any> {
  ...
  set('cpf',               body.cpf);
  set('rg',                body.rg);
  set('data_nascimento',   toIsoDate(body.data_nascimento || body.birth_date || body.birthDate));
  set('sexo',              body.sexo);
  ...
  set('pais',              body.pais || body.address_country || 'Brasil');
  set('tipo_sanguineo',    body.tipo_sanguineo || body.blood_type || body.bloodType);
  set('contato_emergencia',body.contato_emergencia || body.emergency_contact || body.emergencyContact);
...
function mapRow(row: any) {
  return {
    ...
    emergency_contact:  row.contato_emergencia || '',
...
// DELETE /employees/:id  — soft delete (ativo = false)
