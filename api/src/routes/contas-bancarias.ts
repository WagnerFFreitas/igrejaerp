...
router.post('/', async (req, res) => {
  try {
    ...
    const agencia   = b.agencia   || b.agencia     || null;
    const numeroConta = b.numeroConta || b.numero_conta || b.accountNumber || null;
    const moeda     = b.moeda     || b.moeda   || 'BRL';
...
// DELETE /contas_bancarias/:id — soft delete
