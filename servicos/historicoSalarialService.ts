 ...
 * ------------------------
 * Serviço do frontend para salary history service.
 *
 * ONDE É USADO?
 * -------------
 ...
 * ===============
 *
 * Define o bloco principal deste arquivo (salary history service).
 */

class HistoricoSalarialService {
...
export default HistoricoSalarialService;
